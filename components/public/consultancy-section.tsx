...
const statIcons = [Users, BookOpen, FileCheck]
      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            className="space-y-8"
          >
            <span className="text-blue-600 font-bold uppercase tracking-widest text-sm">{section.eyebrow}</span>
              ...
              {section.stats.map((stat, index) => {
                ...
                return (
                  <div key={`${stat.label}-${index}`} className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold text-blue-950">{stat.value}</div>
          ...
          >
            <h3 className="text-2xl font-bold text-blue-950 mb-2">{section.formTitle}</h3>
            <p className="text-gray-500 mb-8 font-medium">{section.formDescription}</p>
