...
export default async function CourseDetailPage({ params }: CourseDetailPageProps) {
  ...
  try {
    allCourses = await getCourses(10)
  } catch (error) {
    console.error("Failed to fetch courses for sidebar:", error)
  }

  const sidebarItems = allCourses
      ...
      <section className="relative h-[500px] flex items-center overflow-hidden bg-blue-950 pt-32 pb-20">
        ...
        <div className="container relative z-20">
          <div className="max-w-4xl">
            ...
            >
              <ArrowRight className="w-4 h-4 rotate-180" /> Explore Courses
            </Link>
          ...
          <div className="lg:col-span-2 space-y-12">
            {course.icon && (
              <div className="relative h-[450px] w-full rounded-[2.5rem] overflow-hidden shadow-2xl border-8 border-gray-50">
                <Image src={course.icon} alt={course.name} fill className="object-cover" />
              </div>
            )}
            ...
            <div className="prose prose-lg max-w-none prose-headings:text-blue-950 prose-p:text-gray-600 prose-li:text-gray-600 prose-strong:text-blue-950">
              ...
              {course.highlights && course.highlights.length > 0 && (
                <div className="mt-12 not-prose">
                  <h3 className="text-2xl font-bold text-blue-950 mb-8">Course Highlights</h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    {course.highlights.map((feature, idx) => (
                      <div
                        key={idx}
                      ...
                      >
                        ...
                        <span className="font-bold text-blue-950/80 group-hover:text-red-600 transition-colors">
                          {feature}
                        </span>
                      </div>
                    ))}
            ...
            <div className="bg-gray-50 p-8 rounded-[2rem] border border-gray-100 sticky top-32">
              ...
              <div className="space-y-3">
                {sidebarItems.map((item, idx) => (
                  ...
                  >
                    <span className="font-bold text-blue-950/70 group-hover:text-red-600 transition-colors">
                      {item.title}
                    </span>
              ...
              <div className="mt-10 p-8 rounded-2xl bg-blue-950 text-white relative overflow-hidden shadow-2xl">
                <div className="relative z-10">
                  ...
                  <p className="text-sm text-blue-200/70 mb-8 font-medium">
                    Talk to our counselors for personalized course recommendations.
                  </p>
