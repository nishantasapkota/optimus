    ...
    <div className="mx-auto max-w-5xl antialiased font-sans px-4 md:px-8 lg:px-12 py-20">
      <div className="relative grid items-center gap-12 md:grid-cols-[1.1fr_0.9fr]">
        <div className="order-2 md:order-1">
          <div className="rounded-3xl border border-neutral-200/70 bg-white/80 p-6 shadow-[0_20px_60px_-30px_rgba(0,0,0,0.35)] backdrop-blur dark:border-neutral-800 dark:bg-neutral-900/70 md:p-8">
            <div className="flex items-center gap-3 text-xs uppercase tracking-[0.25em] text-gray-500 dark:text-neutral-400">
              <span className="h-1.5 w-6 rounded-full bg-gray-900/20 dark:bg-neutral-500/50" />
              Client Notes
            </div>
