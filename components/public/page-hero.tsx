  ...
  return (
    <section className="relative min-h-[520px] flex items-center overflow-hidden bg-slate-950 pt-28 pb-24">
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(70%_80%_at_12%_18%,rgba(37,99,235,0.3),transparent_62%),radial-gradient(60%_70%_at_85%_10%,rgba(220,38,38,0.26),transparent_55%)]" />
        ...
        <div className="absolute -bottom-40 right-[-10%] h-[420px] w-[420px] rounded-full bg-blue-500/20 blur-[160px]" />
        <div className="absolute top-10 left-[-10%] h-[360px] w-[360px] rounded-full bg-red-500/20 blur-[140px]" />
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          >
            ...
            <div className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-5 py-2.5 shadow-[0_0_30px_rgba(255,255,255,0.08)] backdrop-blur-xl">
              <span className="flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-red-500 to-blue-600 text-white shadow-[0_0_24px_rgba(59,130,246,0.45)]">
          ...
          >
            <div className="relative h-64 md:h-80 lg:h-[360px] overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-6 shadow-[0_40px_80px_-60px_rgba(0,0,0,0.9)] backdrop-blur">
              ...
              <div className="absolute left-8 top-8 h-3 w-3 rounded-full bg-red-400 shadow-[0_0_18px_rgba(248,113,113,0.8)]" />
              <div className="absolute right-10 bottom-10 h-4 w-4 rounded-full bg-blue-400 shadow-[0_0_22px_rgba(96,165,250,0.8)]" />
              ...
              <div className="absolute bottom-8 left-8 h-px w-16 bg-gradient-to-r from-red-400 via-white/30 to-transparent" />
              <div className="absolute right-8 top-1/3 h-px w-24 bg-gradient-to-r from-transparent via-blue-300/40 to-transparent" />
            </div>
          </motion.div>
        </div>
      </div>
